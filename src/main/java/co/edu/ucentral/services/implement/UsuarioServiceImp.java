...
public class UsuarioServiceImp implements UsuarioService {
	...
	public boolean validaUsuario(UsuarioDTO usuarioDto) {
		boolean existeUsuario = usuarioRepository.existsById(usuarioDto.getNumeroIdentificacion());
		if (existeUsuario)
			return false;
		else
			return true;
	...
	public UserDetails loadUserByUsername(Integer usuario) {
		...
		UserDetails userDet = new User(usuarioTemp.getNumeroIdentificacion().toString(), usuarioTemp.getPassword(),
				roles);
		return userDet;
	}
